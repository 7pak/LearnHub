...
sealed class Screens(val route:String){
    ...
    object TeacherScreen:Screens(route = "teacher_home_screen")
    object SectionsScreen:Screens(route ="sections_screen/{$GET_COURSE_ID}"){
        fun passCourseId(id: Int): String {
            return this.route.replace("{$GET_COURSE_ID}","$id")
        }
    }
    object VideoScreen:Screens(route ="video_screen/{$GET_SECTION_ID}"){
        fun passSectionId(id: Int): String {
...
//TODO WATCH THE YOUTUBE TUTORIAL ABOUT SHARING ARGUMENTS TO KNOW FORM WHICH SCREEN THE VERI COME